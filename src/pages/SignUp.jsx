        ...
        <div className={`lg:w-2/5 px-6 py-4 bg-gray-100 rounded-xl shadow-lg flex flex-col justify-center transition-all duration-700 ${animatePage ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <form className="space-y-4 w-full max-w-md mx-auto" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="uName" className="block text-gray-700 text-sm font-medium mb-1">User name</label>
              ...
              <div>
                <label htmlFor="uPhone" className="block text-gray-700 text-sm font-medium mb-1">Nomor telepon</label>
            ...
            <div>
              <label htmlFor="uAddress" className="block text-gray-700 text-sm font-medium mb-1">Alamat pengiriman</label>
