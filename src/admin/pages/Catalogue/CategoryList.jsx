...
import { MagnifyingGlassIcon, PlusIcon, XCircleIcon, ChevronDownIcon, PencilIcon, TrashIcon } from '@heroicons/react/24/solid';
import { getCatalogueCategories, createCatalogueCategory, updateCatalogueCategory, deleteCatalogueCategory } from '../../../api/Catalogue/catalogueCategory';
                    ...
                    categories.map((cat) => {
                      return (
                        <tr key={cat.ccId} className="bg-gray-100 hover:bg-secondaryColor/10 rounded-lg shadow-sm">
                          ...
                          <td className="px-4 py-3">{cat.ccIsActive === 1 ? 'Aktif' : 'Nonaktif'}</td>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
              <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
                ...
                <form onSubmit={handleUpdateCategory}>
                  ...
                  <div className='mb-4'>
                    <label htmlFor="editCategoryStatus" className="block text-sm font-medium text-gray-700 mb-1">Status</label>
                    <select
                      id="editCategoryStatus"
                      value={editedCategoryStatus}
                      onChange={e => setEditedCategoryStatus(e.target.value)}
                      className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-secondaryColor"
                      required
                    >
