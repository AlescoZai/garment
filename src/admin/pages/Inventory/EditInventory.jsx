            ...
            <form onSubmit={handleUpdateInventory} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex w-full">
                  <span className="w-1/2 px-4 py-2 bg-primaryColor text-white font-bold rounded-l-xl border border-primaryColor border-r-0 flex items-center justify-center h-[44px]">Kode *</span>
                  <input
                    id="iCode"
                    type="text"
                ...
                <div className="flex w-full">
                  <span className="w-1/2 px-4 py-2 bg-primaryColor text-white font-bold rounded-l-xl border border-primaryColor border-r-0 flex items-center justify-center h-[44px]">Gudang *</span>
                  <input
                    id="iwId"
                    type="text"
                    disabled
                ...
                <div className="flex w-full">
                  <span className="w-1/2 px-4 py-2 bg-primaryColor text-white font-bold rounded-l-xl border border-primaryColor border-r-0 flex items-center justify-center h-[44px]">Kategori Satuan *</span>
                  <input
                    type="text"
                    disabled
                ...
                <div className="flex w-full">
                  <span className="w-1/2 px-4 py-2 bg-primaryColor text-white font-bold rounded-l-xl border border-primaryColor border-r-0 flex items-center justify-center h-[44px]">Jumlah *</span>
                  <input
                    id="iAmount"
                    type="number"
                    disabled
                ...
                <div className="flex w-full">
                  <span className="w-1/2 px-4 py-2 bg-primaryColor text-white font-bold rounded-l-xl border border-primaryColor border-r-0 flex items-center justify-center h-[44px]">Satuan *</span>
                  <input
                    type="text"
                    disabled
              ...
              <div className="w-full flex flex-col gap-2 mt-6">
                <span className="px-4 py-2 bg-primaryColor text-white font-bold rounded-xl border border-primaryColor flex items-center justify-center h-[44px] w-full">Deskripsi *</span>
                <textarea
                  id="iDescription"
