              ...
              <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-4xl text-center">
                ...
                <form onSubmit={handleTransferSubmit} className="space-y-4">
                  <div className="flex gap-2">
                    <CustomDropdown
                      label={<span className="whitespace-nowrap">Pilih Gudang Tujuan</span>}
                    ...
                    <CustomDropdown
                      label={<span className="whitespace-nowrap">Satuan</span>}
                  ...
                  <div className="flex gap-6 items-center justify-center">
                    <div className="flex flex-col items-start">
                      <label className="font-semibold mb-1">Masukkan Jumlah</label>
                      <input
                        type="number"
                        min="1"
